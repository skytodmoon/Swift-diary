...
class DiscoverCell: UITableViewCell {
    ...
    @IBOutlet weak var collectionView: UICollectionView!
     ...
     // MARK: --  懒加载控件
    fileprivate lazy var discoverVM: DiscoverContentViewModel = DiscoverContentViewModel()

    fileprivate var anchorData : [LiveAnchorModel]?
    fileprivate var currentIndex : Int = 0
    
    var cellDidSelected : ((_ anchor : LiveAnchorModel) -> ())?
    ...
    override func awakeFromNib() {
        ...
        // 注册cell
        collectionView.register(UINib(nibName: "DiscoverCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: kDiscoverCollectionViewCellID)
...
extension DiscoverCell : UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: kDiscoverCollectionViewCellID, for: indexPath) as! DiscoverCollectionViewCell
