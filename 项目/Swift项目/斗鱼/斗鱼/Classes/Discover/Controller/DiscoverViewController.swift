...
class DiscoverViewController: UIViewController,SDCycleScrollViewDelegate {
    
    var bannerVM: CarouseViewModel = CarouseViewModel()
...
extension DiscoverViewController {
    func cycleScrollView(_ cycleScrollView: SDCycleScrollView!, didSelectItemAt index: Int) {
        print(index)
        let bannerVC = BannersController()
...
extension DiscoverViewController {
    @objc fileprivate func switchGuessAnchor() {
        ...
        let cell = tableView.visibleCells.first as? DiscoverCell
        cell?.reloadData()
        // 添加动画
...
extension DiscoverViewController {
    fileprivate func setupUI() {
        ...
        // 注册cell
        tableView.register(UINib(nibName: "DiscoverCell", bundle: nil) , forCellReuseIdentifier: kDiscoverID)
    }
    // 猜你喜欢
    fileprivate func setupSectionHeaderView () -> UIView {
        ...
        headerLabel.layer.borderColor = UIColor.orange.cgColor
