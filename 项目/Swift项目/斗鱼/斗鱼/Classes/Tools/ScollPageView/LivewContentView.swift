...
@objc protocol LiveContentViewDelegate : class {
    
    func contentView(_ contentView : LiveContentView, progress : CGFloat, sourceIndex : Int, targetIndex : Int)
    
    @objc optional func contentViewEndScroll(_ contentView : LiveContentView)
}
...
class LiveContentView: UIView {
    ...
    // MARK: 对外属性
    weak var delegate : LiveContentViewDelegate?
...
extension LiveContentView : UICollectionViewDelegate {
