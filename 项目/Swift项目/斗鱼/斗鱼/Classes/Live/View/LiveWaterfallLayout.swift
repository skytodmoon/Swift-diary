...
@objc protocol WaterfallLayoutDataSource : class {
    ...
    /// 返回多少列
    @objc optional func numberOfColsInWaterfallLayout(_ layout : LiveWaterfallLayout) -> Int
}

class LiveWaterfallLayout: UICollectionViewFlowLayout {
    // MARK: 对外提供属性
