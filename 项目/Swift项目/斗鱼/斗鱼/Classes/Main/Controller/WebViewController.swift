...
class WebViewController: UIViewController {
    ...
    fileprivate let loadProgressAnimationView: LoadProgressAnimationView = LoadProgressAnimationView(frame: CGRect(x: 0, y: 0, width: ScreenW, height: 3))
    ...
    override func viewDidLoad() {
        ...
        webView.frame = CGRect(x: 0, y: NavHeight, width: ScreenW, height: view.frame.size.height )
