//
//  OtherWorksViewController.swift
//  有妖气漫画
//
...
class OtherWorksViewController: BaseViewController {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        cw.delegate = self
        cw.dataSource = self
        cw.register(cellType: OtherWorksCCell.self)
        return cw
    }()
...
extension OtherWorksViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: OtherWorksCCell.self)
