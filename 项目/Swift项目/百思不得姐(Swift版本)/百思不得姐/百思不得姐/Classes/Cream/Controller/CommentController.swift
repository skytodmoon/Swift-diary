...
class CommentController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    func setTitle(){
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(CommentController.keyboardWillChangeFrame(_:)), name: UIKeyboardWillChangeFrameNotification, object: nil)
