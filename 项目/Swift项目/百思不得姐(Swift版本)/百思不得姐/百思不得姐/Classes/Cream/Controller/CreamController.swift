...
class CreamController: UIViewController,UIScrollViewDelegate {
    ...
    func setUpNaviBar() {
        ...
        navigationItem.leftBarButtonItem = Common.itemWithImage(UIImage.init(named: "MainTagSubIcon")!,highlightImage:UIImage.init(named: "MainTagSubIconClick")!, target: self, action: #selector(CreamController.tagView))
    ...
    func setUpContentView() {
        ...
        contentView.backgroundColor = QJLBgColor
    ...
    func setUpTitleView (){
        ...
        for i in 0 ..< contentCount {
            ...
            button.addTarget(self, action:#selector(CreamController.didTouchTitleBtn(_:)) , forControlEvents: .TouchUpInside)
