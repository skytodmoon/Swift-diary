...
class HomeViewController: UIViewController {
    ...
    fileprivate lazy var bgView: UIView = {
        let v = UIView(frame: AppScreenBounds)
...
extension HomeViewController {
    ...
    fileprivate func setUpNavgationItem() {
        ...
        revealController.rearViewRevealWidth = AppScreenW*0.82
        ...
        AppNotificationCenter.addObserver(self, selector: #selector(self.mgLeftClickNoti(_:)), name: NSNotification.Name.init("MGLeftClickNoti"), object: nil)
    }
    ...
    fileprivate func setUpNotification() {
        AppNotificationCenter.addObserver(self, selector: #selector(self.sideTableViewCellClick(_:)), name: NSNotification.Name(AppSideTableViewCellClickNoti), object: nil)
        AppNotificationCenter.addObserver(self, selector: #selector(self.sideUserViewClick(_:)), name: NSNotification.Name(AppSideUserViewClickNoti), object: nil)
        AppNotificationCenter.addObserver(self, selector: #selector(self.sideFooterViewClick(_:)), name: NSNotification.Name(AppSideFooterViewClickClickNoti), object: nil)
    }
...
extension HomeViewController: MAMapViewDelegate {
    ...
    func mapInitComplete(_ mapView: MAMapView!) {
        ...
        myPin.lockedScreenPoint = CGPoint(x: AppScreenW/2, y: AppScreenH/2)
...
extension HomeViewController: CarPanelViewDelegate {
    ...
    func carPanelViewInstantUserCarClickBlock(_ view: CarPanelView, _ btn: UIButton) {
        ...
        self.show(revealViewController(), sender: nil)
    }
