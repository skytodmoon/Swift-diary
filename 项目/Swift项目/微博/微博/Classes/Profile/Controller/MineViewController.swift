...
class MineViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        /// 点击头部上的一些操作
        LoginHeaderViewClicked()

    }
    
    // 头部视图
    fileprivate lazy var noLoginHeaderView: LoginHeaderView = {
        let noLoginHeaderView = LoginHeaderView.headerView()
        return noLoginHeaderView
    }()

}

// MARK: - LoginHeaderView 点击头部上的一些操作
extension MineViewController {
    /// 点击头部上的一些操作
    fileprivate func LoginHeaderViewClicked() {
        /// 更多登录方式按钮点击
