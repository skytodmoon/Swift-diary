...
@interface QJLStage13BottomView ()
...
@implementation QJLStage13BottomView
...
- (void)changeBottomImageViewWihtIndex:(NSInteger)index type:(QJLStage13BottomType)type {
    if (type == QJLStage13BottomTypeNone) {
        if (index == 0) {
    ...
    } else if (type == QJLStage13BottomTypePeople) {
        if (index == 0) {
    ...
    } else if (type == QJLStage13BottomTypeTick) {
        if (index == 0) {
...
- (void)cleanData {
    [self changeBottomImageViewWihtIndex:0 type:QJLStage13BottomTypePeople];
    [self changeBottomImageViewWihtIndex:1 type:QJLStage13BottomTypePeople];
    [self changeBottomImageViewWihtIndex:2 type:QJLStage13BottomTypePeople];
