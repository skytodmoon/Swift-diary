...
#import "QJLDropEggView.h"

@interface QJLStage12EggView ()
{
    int _speed;
    int _count;
}

@property (nonatomic, strong) QJLDropEggView *egg1;
@property (nonatomic, strong) QJLDropEggView *egg2;
@property (nonatomic, strong) QJLDropEggView *egg3;
@property (nonatomic, assign) int stopCount;

@end

@implementation QJLStage12EggView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        
        self.egg1 = [[QJLDropEggView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth / 3, ScreenHeight - 200)];
        [self buildEggView:self.egg1 tag:0];
        
        self.egg2 = [[QJLDropEggView alloc] initWithFrame:CGRectMake(ScreenWidth / 3, 0, ScreenWidth / 3, ScreenHeight - 200)];
        [self buildEggView:self.egg2 tag:1];
        
        self.egg3 = [[QJLDropEggView alloc] initWithFrame:CGRectMake(ScreenWidth / 3 * 2, 0, ScreenWidth / 3, ScreenHeight - 200)];
...
- (void)buildEggView:(QJLDropEggView *)eggView tag:(NSInteger)tag {
