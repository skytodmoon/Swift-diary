...
#import "QJLIceView.h"
#import "QJLColumnIceView.h"
#import "PrefixHeader.pch"
@interface QJLIceView ()
{
    int _random1;
    int _random2;
    int _random3;
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        for (int i = 0; i < 3; i++) {
            QJLColumnIceView *colView = [QJLColumnIceView viewFromNib];
...
- (void)showDottedLineView {
    ...
    for (int i = 0; i < 3; i++) {
        switch (i) {
            case 0:
                [(QJLColumnIceView *)self.colViews[i] showColumnDottedLineWithNum:_random1];
                break;
            case 1:
                [(QJLColumnIceView *)self.colViews[i] showColumnDottedLineWithNum:_random2];
                break;
            case 2:
                [(QJLColumnIceView *)self.colViews[i] showColumnDottedLineWithNum:_random3];
                break;
            default:
                break;
        }
...
- (void)addIceWithIndex:(NSInteger)index {
    if (index == 0) {
        ...
        [UIView animateWithDuration:0.15 animations:^{
            ...
            [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundArrivalName];
            [self examineState];
        }];
    }
