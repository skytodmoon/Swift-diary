...
@interface QJLStage09ViewController ()

@property (nonatomic, strong) QJLStage09BobmView *bobmView;

@end

@implementation QJLStage09ViewController
...
- (void)buildStageInfo {
    ...
    self.bobmView = [[QJLStage09BobmView alloc] initWithFrame:CGRectMake(0, 0, 16, ScreenHeight - 16 - self.redButton.frame.size.height)];
