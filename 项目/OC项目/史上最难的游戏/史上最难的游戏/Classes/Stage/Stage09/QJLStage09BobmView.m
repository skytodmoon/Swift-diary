...
#import "QJLStage09BobmView.h"
#import "QJLBobmView.h"
#import "QJLStage09ResultView.h"
#import "PrefixHeader.pch"

@interface QJLStage09BobmView ()
{
    int _stopCount;
    int _count;
    int _ms;
...
@property (nonatomic, strong) QJLBobmView *bobmView1;
@property (nonatomic, strong) QJLBobmView *bobmView2;
@property (nonatomic, strong) QJLBobmView *bobmView3;
@property (nonatomic, strong) CADisplayLink *timer;
@property (nonatomic, strong) QJLStage09ResultView *resultView1;
@property (nonatomic, strong) QJLStage09ResultView *resultView2;
@property (nonatomic, strong) QJLStage09ResultView *resultView3;

@end

@implementation QJLStage09BobmView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        __weak typeof(self) weakSelf = self;
        
        self.bobmView1 = [QJLBobmView viewFromNib];
        ...
        self.bobmView2 = [QJLBobmView viewFromNib];
        ...
        self.bobmView3 = [QJLBobmView viewFromNib];
        ...
        self.resultView1 = [QJLStage09ResultView viewFromNib];
...
- (void)bobmWithIndex:(int)index {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.4 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundLaunchBoum];
...
- (void)showKaCViewWithIndex:(int)index {
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundKaChaName];
...
- (void)showBobm {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundPaName];
...
- (void)updateTime {
    ...
    if (_ms == 40) {
        _ms = 0;
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundCountDownName];
    }
}
