...
@interface QJLStage19ViewController ()
{
    int _index;
    BOOL _hasFish;
    BOOL _playAgain;
...
@property (nonatomic, strong) QJLStage19FishView *fishView;
...
@implementation QJLStage19ViewController
...
- (void)buildFishView {
    self.fishView = [[QJLStage19FishView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - self.redButton.frame.size.height)];
...
- (void)stopMotionAndShowSucess {
    ...
    __block QJLResultStateType type;
