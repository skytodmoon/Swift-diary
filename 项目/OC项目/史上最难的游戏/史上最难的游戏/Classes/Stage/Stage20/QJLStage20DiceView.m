...
#import "QJLStage20DiceView.h"
#import "QJLDiceView.h"
#import "PrefixHeader.pch"

@interface QJLStage20DiceView ()
{
    int _count;
    int _diceView1Num1;
    int _diceView1Num2;
...
@property (nonatomic, strong) QJLDiceView *dice1;
@property (nonatomic, strong) QJLDiceView *dice2;
@property (nonatomic, strong) QJLDiceView *dice3;

@end

@implementation QJLStage20DiceView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.dice1 = [QJLDiceView viewFromNib];
        [self addSubview:self.dice1];
        
        self.dice2 = [QJLDiceView viewFromNib];
        self.dice2.frame = CGRectMake(ScreenWidth / 3, 0, ScreenWidth / 3, self.dice2.frame.size.height);
        [self addSubview:self.dice2];
        
        self.dice3 = [QJLDiceView viewFromNib];
...
- (int)startShakeDice {
    ...
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundRollDiceName];
