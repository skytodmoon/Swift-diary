...
@interface QJLStage20ViewController ()
{
    int _maxIndex;
    int _timeCount;
    int _diceCount;
...
@property (nonatomic, strong) QJLStage20DiceView *diceView;
@property (nonatomic, assign) NSInteger allScore;
@property (nonatomic, strong) CADisplayLink *timer;

@end

@implementation QJLStage20ViewController
...
- (void)buildDiceView {
    self.diceView = [[QJLStage20DiceView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - self.redButton.frame.size.height)];
