...
@implementation QJLSoundToolManager

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

static QJLSoundToolManager *instance = nil;

+ (instancetype)sharedSoundToolManager {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[QJLSoundToolManager alloc] init];
    });
                       ...
                       UInt32 inPropertyValueSize, const void *inPropertyValue)
{
    ...
    if (value > 0) {
        ...
        [[QJLSoundToolManager sharedSoundToolManager] pauseBgMusic];
    }
}
