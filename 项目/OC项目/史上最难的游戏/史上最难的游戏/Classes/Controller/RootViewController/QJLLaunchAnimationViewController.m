//
//  QJLLaunchAnimationViewController.m
//  Game
//
...
@interface QJLLaunchAnimationViewController ()
{
    int _clickCount;
    int _keyCount;
...
@implementation QJLLaunchAnimationViewController
...
- (void)handButtonImageViewClickAnimation {
    ...
    [UIView animateWithDuration:kClickAnimationDuration * 0.5 animations:^{
        ...
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundLaunchClickName];
...
- (void)startBombAnimation {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundLaunchBoum2];
