...
@interface DetailViewController () <UITableViewDataSource,UITableViewDelegate,CartoonFlooterViewDelegate>
...
- (void)requestData {
    ...
    [comicsModel requestModelDataWithUrlString:url complish:^(id res) {
        ...
        DetailViewController *sself = weakSelf;
    ...
    if (indexPath.section == 0) {
        ...
        [cell.content sd_setImageWithURL:imageUrl placeholderImage:placeImage_comic
                               ...
                               completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                                   ...
                                   __strong DetailViewController *sself = weakSelf;
