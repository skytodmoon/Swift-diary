...
@interface QJLEssenceViewController ()<UIScrollViewDelegate>
...
@implementation QJLEssenceViewController
...
-(void)setupChildViewControllers {
    QJLTopicViewController *allVC = [[QJLTopicViewController alloc] init];
    allVC.title = @"全部";
    allVC.type = QJLTopicTypeAll;
    [self addChildViewController:allVC];
    QJLTopicViewController *videoVC = [[QJLTopicViewController alloc] init];
    videoVC.title = @"视频";
    videoVC.type = QJLTopicTypeVideo;
    [self addChildViewController:videoVC];
    QJLTopicViewController *voiceVC = [[QJLTopicViewController alloc] init];
    voiceVC.title = @"声音";
    voiceVC.type = QJLTopicTypeVoice;
    [self addChildViewController:voiceVC];
    QJLTopicViewController *pictureVC = [[QJLTopicViewController alloc] init];
    pictureVC.title = @"图片";
    pictureVC.type = QJLTopicTypePicture;
    [self addChildViewController:pictureVC];
    QJLTopicViewController *wordVC = [[QJLTopicViewController alloc] init];
    wordVC.title = @"段子";
    wordVC.type = QJLTopicTypeWord;
...
-(void)setupTitlesView {
    ...
    titlesView.frame = CGRectMake(0, QJLTitlesViewY, self.view.width, QJLTitlesViewH);
...
-(void)tagButtonClick {
    QJLRecommandTagsViewController *tagVC = [[QJLRecommandTagsViewController alloc] init];
