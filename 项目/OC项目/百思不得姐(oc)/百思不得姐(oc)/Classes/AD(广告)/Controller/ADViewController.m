...
- (void)setupADData
{
    ...
    [Networking GET:@"http://mobads.baidu.com/cpro/ui/mads.php" baseURL:nil params:parameters success:^(NSURLSessionDataTask *task, id responseObject) {
        
        //获取广告字典
        NSDictionary *adDic = [responseObject[@"ad"] firstObject];
        
        //字典转模型
        ADItem *item = [ADItem mj_objectWithKeyValues:adDic];
