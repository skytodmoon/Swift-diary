...
- (void)setupTopTitleView
{
    ...
    UIScrollView *topView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 64, ScreenW, 35)];
...
- (void)setupAllTitle
{
    ...
    CGFloat btnW = ScreenW / _topTitleBtn;
    CGFloat btnX;
...
- (void)selButton:(UIButton *)titleBtn
{
    ...
    CGFloat offsetX = titleBtn.center.x - ScreenW * 0.5;
    
    if (offsetX < 0) {
        offsetX = 0;
    }
    
    CGFloat MaxOffserX = self.topView.contentSize.width - ScreenW;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    //设置按钮文字的大小缩放
    CGFloat scaleR = scrollView.contentOffset.x / ScreenW - leftI;
    ...
    //    _underLine._x = scrollView.contentOffset.x / _titleBtns.count ;
    //    _underLine._x= scrollView._x / _titleBtns.count +1;
