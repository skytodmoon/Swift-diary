...
static NSString *const PlaceholderColor = @"placeholderLabel.textColor";
...
- (void)awakeFromNib
{
    ...
    [self setValue:[UIColor lightGrayColor] forKeyPath:PlaceholderColor];
//    [self setValue:[UIFont stemFontOfSize:14] forKey:@"placeholderLabel.font"];
...
{
    [self setValue:[UIColor whiteColor] forKeyPath:PlaceholderColor];
}
