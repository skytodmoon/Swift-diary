...
-(void)initView{
    ...
    [addCart setBackgroundColor:Color(255, 100, 98)];
    ...
    switch (indexPath.section) {
        case 0:
            if (indexPath.row==0) {
                ...
                cell.detailTextLabel.textColor=Color(255, 100, 98);
        ...
        case 1:
            ...
            cell.textLabel.textColor=Color(147, 147, 147);
            cell.textLabel.font = [UIFont systemFontOfSize:15];
            cell.detailTextLabel.textColor=Color(79, 79, 79);
            cell.detailTextLabel.font = [UIFont systemFontOfSize:15];
            break;
        case 2:
            if (indexPath.row==0) {
...
- (UIView*)addFooterBar{
    ...
    moneyName.text=@"商品金额";
    moneyName.textColor=Color(147, 147, 147);
    ...
    money.textColor=Color(255, 100, 98);
    ...
    freightName.text=@"运费";
    freightName.textColor=Color(147, 147, 147);
    ...
    freight.textColor=Color(255, 100, 98);
...
- (UISwitch *)autoSwitch
{
    if (_autoLoginSwitch == nil) {
        ...
        _autoLoginSwitch.onTintColor=Color(240, 97, 98);//处于on时switch 的颜色
