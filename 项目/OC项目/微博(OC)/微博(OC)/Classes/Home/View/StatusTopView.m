...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        nameBtn.titleLabel.font = [UIFont systemFontOfSize:StatusNameFont];
        ...
        timeLabel.font = [UIFont systemFontOfSize:StatusTimeFont];
        timeLabel.textColor = Color(135, 135, 135);
        [self addSubview:timeLabel];
        self.timeLabel = timeLabel;
        
        // 5. 来源
        UILabel *sourceLabel = [[UILabel alloc] init];
        sourceLabel.font = [UIFont systemFontOfSize:StatusSourceFont];
        sourceLabel.textColor = Color(135, 135, 135);
        [self addSubview:sourceLabel];
        self.sourceLabel = sourceLabel;
        
        // 6. 正文
        UILabel *contentLabel = [[UILabel alloc] init];
        contentLabel.font = [UIFont systemFontOfSize:StatusContentFont];
        contentLabel.textColor = Color(35, 35, 35);
...
- (void)setStatusFrame:(StatusFrame *)statusFrame
{
    ...
    CGFloat timeY = CGRectGetMaxY(self.statusFrame.nameBtnF) + StatusPadding * 0.5;
    CGSize timeSize = [status.created_at sizeWithFont:[UIFont systemFontOfSize:StatusTimeFont]];
    self.timeLabel.frame = (CGRect){timeX, timeY, timeSize};
    
    // 来源
    self.sourceLabel.text = status.source;
    CGFloat sourceX = CGRectGetMaxX(self.timeLabel.frame) + StatusPadding * 0.5;
