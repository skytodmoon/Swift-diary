...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        if (indexPath.row==0) {
            cell.detailTextLabel.textColor=Color(240, 97, 98);
...
- (UISwitch *)autoPeiSongSwitch
{
    if (_autoPeiSongSwitch== nil) {
        ...
        _autoPeiSongSwitch.onTintColor=Color(240, 97, 98);//处于on时switch 的颜色
...
- (UISwitch *)autoYouHuoSwitch
{
    if (_autoYouHuoSwitch== nil) {
        ...
        _autoYouHuoSwitch.onTintColor=Color(240, 97, 98);//处于on时switch 的颜色
...
- (UISwitch *)autoFukuanSwitch
{
    if (_autoFukuanSwitch== nil) {
        ...
        _autoFukuanSwitch.onTintColor=Color(240, 97, 98);//处于on时switch 的颜色
