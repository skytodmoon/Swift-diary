...
- (void)initView{
                                        ...
                                        andSelectionBlock:^(NSUInteger segmentIndex) {
                                            switch (segmentIndex) {
                                                ...
                                                case 2:
                                                    ...
                                                    break;
                                                case 3:
                                                    [(QJLNavigationController*)self.navigationController showRightMenu];
                                                    break;
    ...
    segmented.textAttributes=@{NSFontAttributeName:[UIFont systemFontOfSize:14],
                               NSForegroundColorAttributeName:Color(135, 127, 141)};
    segmented.selectedTextAttributes=@{NSFontAttributeName:[UIFont systemFontOfSize:14],
                                       NSForegroundColorAttributeName:Color(243, 106, 107)};
    ...
    _tableView.backgroundColor=Color(240, 243, 245);
