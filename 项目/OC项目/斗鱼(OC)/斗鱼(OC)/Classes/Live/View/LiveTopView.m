...
- (void)setup {
    ...
    self.layer.borderColor = Color(233, 233, 233).CGColor;
...
- (void)setTags:(NSArray *)tags {
    ...
    [allBtn setBackgroundImage:[self buttonImageFromColor:Color(238, 238, 238)] forState:UIControlStateNormal];
    ...
    for (int i = 0; i < tags.count; i++) {
        ...
        [btn setBackgroundImage:[self buttonImageFromColor:Color(238, 238, 238)] forState:UIControlStateNormal];
...
- (void)willMoveToSuperview:(UIView *)newSuperview {
    ...
    downView.backgroundColor = Color(221, 221, 220);
    [self.superView addSubview:downView];
    self.downView = downView;
}

#pragma mark LiveDownViewDelegate
