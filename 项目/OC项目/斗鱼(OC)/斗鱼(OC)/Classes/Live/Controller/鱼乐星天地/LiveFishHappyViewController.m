...
@interface LiveFishHappyViewController () <LiveTopViewDelegate>
...
@implementation LiveFishHappyViewController
...
//    [[HttpManager sharedInstance] GET:@"http://capi.douyucdn.cn/api/v1/getHotRoom/2?aid=ios&client_sys=ios&time=1468825800&auth=94d0ae945c16542cc6dee7fe031f1316" parameters:nil success:^(AFHTTPRequestOperation * _Nonnull operation, NSData *responseObject) {
//        NSDictionary *dict = [NSJSONSerialization JSONObjectWithData:responseObject.mj_JSONData options:NSJSONReadingMutableContainers error:nil];
