...
@implementation DetailAllCourseCell
...
/**< 学校查看所有课程模块传参时用 */
-(void)setJzAllCourseM:(DetailAllCourseModel *)jzAllCourseM{
...
/**< 课程分类模块传参时用 */
-(void)setJzCateM:(DetailCateModel *)jzCateM{
    _jzCateM = jzCateM;
