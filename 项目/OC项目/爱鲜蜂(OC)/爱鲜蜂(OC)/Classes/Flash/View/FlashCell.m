...
+ (instancetype)cellWithTable:(UITableView *)tableView{
    FlashCell *cell = [tableView dequeueReusableCellWithIdentifier:flashCell];
    if (!cell) {
        cell = [[FlashCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:flashCell];
    }
    return cell;
}
