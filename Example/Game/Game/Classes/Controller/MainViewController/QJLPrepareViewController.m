...
#import "QJLPrepareScoreView.h"
#import "QJLGameControllerViewManager.h"
#import "QJLBaseGameViewController.h"
#import "PrefixHeader.pch"
@interface QJLPrepareViewController ()

@property (weak, nonatomic) IBOutlet QJLPrepareScoreView *scoreView;
@property (weak, nonatomic) IBOutlet QJLFullBackgroundView *animationView;
...
@implementation QJLPrepareViewController
...
- (void)startTitleAnimation {
    ...
    for (int i = 0; i < self.labels.count; i++) {
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)((i + 1) * 0.25 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundPrepaerTitle(i+1)];
        });
...
- (IBAction)playGameClick {
    ...
    QJLPrepareViewController *gameVC = [QJLGameControllerViewManager viewControllerWithStage:self.stage];
