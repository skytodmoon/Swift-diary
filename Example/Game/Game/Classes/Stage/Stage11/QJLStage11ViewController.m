...
#import "QJLStage11BottomNumView.h"
#import "QJLTimeCountView.h"
#import "QJLCountTimeView.h"
#import "PrefixHeader.pch"

@interface QJLStage11ViewController ()

@property (nonatomic, strong) QJLStage11View *blackboardView;
@property (nonatomic, strong) QJLStage11BottomNumView *bottomNumView;
...
@implementation QJLStage11ViewController
...
- (void)buildStageInfo {
    ...
    self.blackboardView = [[QJLStage11View alloc] initWithFrame:ScreenBounds];
    ...
    self.bottomNumView = [[QJLStage11BottomNumView alloc] initWithFrame:CGRectMake(0, self.redButton.frame.origin.y + 4, ScreenWidth, self.redButton.frame.size.height)];
...
- (void)showResultStatusWithIsSucess:(BOOL)sucess animationFinish:(void (^)(void))finish {
    ...
    if (sucess) {
        ...
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundEnenName];
