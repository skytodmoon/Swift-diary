...
class MapView: MAMapView {
    ...
    private lazy var myLocalBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(MapView.backCurrentLocal), forControlEvents: .TouchUpInside)
        return btn
    }()
...
extension MapView: UICollectionViewDelegate, UICollectionViewDataSource {
