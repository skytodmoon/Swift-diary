...
@interface QJLStage18PokerView ()

@property (nonatomic, strong) NSMutableArray *pokerArr;

@end

@implementation QJLStage18PokerView
{
    BOOL _same1;
    BOOL _same2;
    BOOL _same3;
...
- (BOOL)showPokerView {
    ...
    QJLPokerView *leftPokerView = [QJLPokerView viewFromNib];
    leftPokerView.frame = kLeftPokerViewFrame;
    [self addSubview:leftPokerView];
    
    QJLPokerView *middlePokerView = [QJLPokerView viewFromNib];
    middlePokerView.frame = kMiddlePokerViewFrame;
    [self addSubview:middlePokerView];
    
    QJLPokerView *rightPokerView = [QJLPokerView viewFromNib];
    ...
    QJLPokerType leftType = arc4random_uniform(4);
    QJLPokerType middleType = arc4random_uniform(4);
    QJLPokerType rightType = arc4random_uniform(4);
    ...
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundDealName];
