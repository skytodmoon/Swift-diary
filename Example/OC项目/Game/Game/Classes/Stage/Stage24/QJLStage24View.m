...
#import "QJLCockroachView.h"
#import "PrefixHeader.pch"

@interface QJLStage24View ()
{
    int _cockorder1;
    int _cockorder2;
    int _cockorder3;
...
@property (nonatomic, strong) QJLCockroachView *cock1;
@property (nonatomic, strong) QJLCockroachView *cock2;
@property (nonatomic, strong) QJLCockroachView *cock3;
...
@implementation QJLStage24View

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        __weak typeof(self) weakSelf = self;
        
        self.cock1 = [QJLCockroachView viewFromNib];
        self.cock1.tag = 10;
        ...
        self.cock2 = [QJLCockroachView viewFromNib];
        self.cock2.tag = 11;
        ...
        self.cock3 = [QJLCockroachView viewFromNib];
        self.cock3.tag = 12;
