...
- (void)startRotation {
    ...
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundRollingName2];
...
- (void)setAnimFinishCount:(int)animFinishCount {
    ...
    if (_animFinishCount == 2) {
        // 动画完成
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundJackpotStop];
