...
@interface QJLStage03HeaderView ()
{
...
@implementation QJLStage03HeaderView
...
- (void)start {
    ...
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSOundNoitSoundName];
}
...
- (void)fail {
    if (_transform.c > 0) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundWheezeSoundName];
