...
#import "QJLStage14DogView.h"
#import "QJLStage14LineView.h"
#import <CoreMotion/CoreMotion.h>
#import "QJLTimeCountView.h"
#import "PrefixHeader.pch"

@interface QJLStage14ViewController ()
{
    int _index;
    int _count;
    BOOL _isToRight;
...
@property (nonatomic, strong) QJLStage14DogView *dogView;
@property (nonatomic, strong) QJLStage14LineView *lineView;
...
@implementation QJLStage14ViewController
...
- (void)buildStageInfo {
    ...
    self.dogView = [QJLStage14DogView viewFromNib];
    ...
    self.lineView = [QJLStage14LineView viewFromNib];
...
- (void)setAngle:(float)angle {
    ...
    if (angle > 0.8 || angle < -0.8) {
        ...
        self.scroe = [(QJLTimeCountView *)self.countScore stopCalculateTime];
        [self.motionManager stopAccelerometerUpdates];
        [self.timer invalidate];
        self.timer = nil;
        
        [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundDogbarkTwoName];
