...
@property (weak, nonatomic) IBOutlet QJLStrokeLabel *label1;
@property (weak, nonatomic) IBOutlet QJLStrokeLabel *label2;
@property (weak, nonatomic) IBOutlet UIImageView *backgroundImageView;
@property (nonatomic, strong) CADisplayLink *timer;

@end

@implementation QJLTimeCountView
