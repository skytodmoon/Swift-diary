...
+ (void)showReadyGoViewWithSuperView:(UIView *)superView completion:(void (^)(void))completion {
    ...
    QJLReadyGoView *readyGoView = [[QJLReadyGoView alloc] initWithFrame:CGRectMake(ScreenWidth, startY, ScreenWidth, 95)];
    [superView addSubview:readyGoView];
    [superView bringSubviewToFront:readyGoView];
    
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundReadyGoName];
