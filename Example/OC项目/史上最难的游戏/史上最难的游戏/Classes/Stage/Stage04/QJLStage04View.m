...
- (void)runWithIsLeft:(BOOL)isLeft {
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundGoUpstairs];
    _runCount++;
    _isSucceed = NO;
...
- (void)succeedAnimation {
    ...
    if (_isSucceed) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundStage04Name];
...
- (void)failAnimation {
    [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundFailToJumpName];
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            [[QJLSoundToolManager sharedSoundToolManager] playSoundWithSoundName:kSoundWaterName];
            [UIView animateWithDuration:0.2 animations:^{
