...
class VideoTableViewController: UITableViewController, SDCycleScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.registerClass(VideoCell.self, forCellReuseIdentifier: newsReuseIdentifier)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(newsReuseIdentifier) as! VideoCell
...
//         请求文章详情数据
                ...
                let detailVc = UIStoryboard(name: "NewsDetailViewController", bundle: nil).instantiateInitialViewController() as! NewsDetailViewController
