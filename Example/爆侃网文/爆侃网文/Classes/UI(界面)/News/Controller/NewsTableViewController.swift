...
class NewsTableViewController: UITableViewController,SDCycleScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.registerNib(UINib(nibName: "NewsNoPicCell", bundle: nil), forCellReuseIdentifier: newsNoPicCell)
        tableView.registerNib(UINib(nibName: "NewsOnePicCell", bundle: nil), forCellReuseIdentifier: newsOnePicCell)
        tableView.registerNib(UINib(nibName: "NewsThreePicCell", bundle: nil), forCellReuseIdentifier: newsThreePicCell)
        ...
        if articleList.count >= 3 {
            ...
            if postModel.piccount == 0 {
                if postModel.rowHeight == 0 {
                    let cell = tableView.dequeueReusableCellWithIdentifier(newsNoPicCell) as! NewsNoPicCell
                ...
                if postModel.rowHeight == 0 {
                    let cell = tableView.dequeueReusableCellWithIdentifier(newsThreePicCell) as! NewsThreePicCell
                    let height = cell.getRowHeight(postModel)
                    postModel.rowHeight = height
                }
                return postModel.rowHeight
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if articleList.count >= 3 {
            ...
            if postModel.piccount == 0 {
                ...
                let cell = tableView.dequeueReusableCellWithIdentifier(newsOnePicCell) as! NewsOnePicCell
                cell.postModel = postModel
                return cell
            } else if postModel.piccount == 3 {
                let cell = tableView.dequeueReusableCellWithIdentifier(newsThreePicCell) as! NewsThreePicCell
