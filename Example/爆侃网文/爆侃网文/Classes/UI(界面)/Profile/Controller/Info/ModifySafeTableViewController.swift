//
//  ModifySafeTableViewController.swift
//  爆侃网文
//
...
class ModifySafeTableViewController: BaseTableViewController {
    ...
    override func viewDidLoad() {
        ...
        let group1CellModel1 = ProfileCellModel(title: "原密码:")
        let group1CellModel2 = ProfileCellModel(title: "新密码:")
        let group1CellModel3 = ProfileCellModel(title: "确认新密码:")
        let group1CellModel4 = ProfileCellModel(title: "邮箱:")
        let group1 = ProfileCellGroupModel(cells: [group1CellModel1, group1CellModel2, group1CellModel3, group1CellModel4])
        groupModels = [group1]
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 2:
            ...
            return cell
        case 3:
            emailField.text = AccountModel.shareAccount()!.email!
    ...
    func didTappedSaveButton(button: UIButton) -> Void {
        ...
        NetworkTool.shareNetworkTool.post(MODIFY_ACCOUNT_INFO, parameters: parameters) { (success, result, error) in
            if result != nil {
                ...
                ProgressHUD.showInfoWithStatus("修改失败，请联系管理员！")
            }
        }
    }
