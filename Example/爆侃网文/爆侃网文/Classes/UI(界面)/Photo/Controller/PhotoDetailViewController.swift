...
class PhotoDetailViewController: UIViewController {
    ...
    private var photoModels = [PhotoDetailModel]()
            ...
            if success == true {
                if let successResult = result {
                    ...
                    for picJSON in morepic {
                        ...
                        let model = PhotoDetailModel(dict: dict)
    ...
    @objc private func didTappedRightBarButtonItem(item: UIBarButtonItem) -> Void {
        ...
        ProgressHUD.showInfoWithStatus("举报成功，谢谢您的支持")
    }
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.registerClass(PhotoDetailCell.self, forCellWithReuseIdentifier: self.photoIdentifier)
    ...
    /// 底部工具条
    private lazy var bottomToolView: PhotoBottomBar = {
        let bottomToolView = NSBundle.mainBundle().loadNibNamed("PhotoBottomBar", owner: nil, options: nil).last as! PhotoBottomBar
...
extension PhotoDetailViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(photoIdentifier, forIndexPath: indexPath) as! PhotoDetailCell
        cell.delegate = self
...
// MARK: - CommentCommitViewDelegate, PhotoBottomBarDelegate
extension PhotoDetailViewController: CommentCommitViewDelegate, PhotoBottomBarDelegate {
