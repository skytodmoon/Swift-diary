//
//  EditColumnViewController.swift
//  爆侃网文
//
...
class EditColumnViewController: UIViewController,EditColumnViewCellDelegate {
    ...
    private func prepareUI() {
        ...
        collectionView.registerClass(EditColumnViewCell.classForCoder(), forCellWithReuseIdentifier: cellIdentifier)
        collectionView.registerClass(ColumnReusableView.classForCoder(), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: headOne)
        collectionView.registerClass(ColumnReusableView.classForCoder(), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: headTwo)
        collectionView.reloadData()
    }
    
    // MARK: - 各种排序处理方法
    func sortItem(pan: UIPanGestureRecognizer) -> Void {
        let cell = pan.view as! EditColumnViewCell
    ...
    func deleteItemWithIndexPath(indexPath: NSIndexPath) -> Void {
        ...
        for index in 0 ..< selectedArray!.count {
            ...
            let cell = collectionView.cellForItemAtIndexPath(newIndexPath) as! EditColumnViewCell
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        ...
        if indexPath.section == 1 {
            ...
            let endCell = collectionView.cellForItemAtIndexPath(indexPath) as! EditColumnViewCell
            ...
            UIView.animateWithDuration(0.7, animations: {
                self.animationLabel.center = endAttributes!.center
                    ...
                    let endCell = collectionView.cellForItemAtIndexPath(toIndexPath) as! EditColumnViewCell
...
extension EditColumnViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, atIndexPath indexPath: NSIndexPath) -> UICollectionReusableView {
        var reusableView: ColumnReusableView?
        
        if kind == UICollectionElementKindSectionHeader {
            if indexPath.section == 0 {
                reusableView = collectionView.dequeueReusableSupplementaryViewOfKind(UICollectionElementKindSectionHeader, withReuseIdentifier: headOne, forIndexPath: indexPath) as? ColumnReusableView
                ...
                reusableView = collectionView.dequeueReusableSupplementaryViewOfKind(UICollectionElementKindSectionHeader, withReuseIdentifier: headTwo, forIndexPath: indexPath) as? ColumnReusableView
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(cellIdentifier, forIndexPath: indexPath) as! EditColumnViewCell
